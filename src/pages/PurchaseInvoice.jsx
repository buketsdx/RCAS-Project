          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-col items-end space-y-2">
                <div className="flex justify-between w-64"><span>Subtotal:</span><span className="font-medium">{totals.gross.toFixed(2)} SAR</span></div>
                <div className="flex justify-between w-64"><span>VAT:</span><span className="font-medium">{totals.vat.toFixed(2)} SAR</span></div>
                <div className="flex justify-between w-64 pt-2 border-t"><span className="text-lg font-semibold">Total:</span><span className="text-lg font-bold text-blue-600">{totals.net.toFixed(2)} SAR</span></div>
              </div>
            </CardContent>
          </Card>
